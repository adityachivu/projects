...
\label{Test} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Test Chapter. \emph{Chapter Title Here}} % This is for the header on each page - perhaps a shortened title
